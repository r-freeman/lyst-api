...
<nav class="flex shadow items-center justify-between flex-wrap p-5">
    ...
    <div class="w-auto sm:flex sm:items-center sm:w-auto">
        ...
        <div>
            ...
            @guest
                <a href="{{ route('login') }}"
                   class="mt-4 sm:inline-block sm:mt-0 text-mineshaft hover:text-safetyorange mr-4">
                    {{ __('Login') }}
                </a>
            ...
            @else
                ...
                <a href="{{ route('logout') }}" onclick="event.preventDefault();
                  document.getElementById('logout-form').submit();"
                   class="mt-4 sm:inline-block sm:mt-0 text-dovegrey hover:text-safetyorange mr-4">
                    {{ __('Logout') }}
                </a>
